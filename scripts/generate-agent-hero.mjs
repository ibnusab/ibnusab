...
const profileLines = [
  { type: "header", value: "ibnu@agentlab" },
  { type: "row", key: "Subject", value: "Ibnu Sabrian" },
  { type: "row", key: "Role", value: "Web Builder & Android Developer" },
  { type: "row", key: "Affiliation", value: "STMIK Widya Utaa" },
  { type: "row", key: "Base", value: "Purbalingga, Central Java" },
  ...
  { type: "row", key: "Direction", value: "AI Agent / Assistant Research" },
  { type: "row", key: "Themes", value: "AI Agent, AI Research, AI Assistant" },
  { type: "blank" },
  ...
  { type: "row", key: "GitHub", value: "@ibnusabrian" },
  { type: "footer", value: "signal.locked > AI / RESEARCH / ASSISTANT" }
];
...
<title id="title">Ibnu Sabrian - Web Builder and Android Developer</title>
...
<text x="${titleCenter}" y="${titlebar.y + titlebar.height / 2 + 5}" text-anchor="middle" class="terminal-label">ibnu@agentlab ~ % ./profile --live</text>
...
<text x="${layout.width / 2}" y="${layout.footerY}" text-anchor="middle" class="mono" font-size="10" letter-spacing="1.5" fill="${colors.muted}">AI AGENTS / AI RESEARCH / AI ASSISTANT</text>
